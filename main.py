...
import argparse
from UserAgent import * #The new fancy UserAgent generator
ua = UserAgent()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-proxylist", type=str,
                        help="Hier kannst du deine eigene Proxylist einfügen, falls du eine besitzt. Wenn nicht, wird trotzdem eine benutzt. Sicherheit und so.")
